...
class ListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post list_items_url, params: { list_item: { completed: @list_item.completed, description: @list_item.description, name: @list_item.name, todo_list_id: @list_item.todo_list_id } }
    end
  ...
  test "should update list_item" do
    patch list_item_url(@list_item), params: { list_item: { completed: @list_item.completed, description: @list_item.description, name: @list_item.name, todo_list_id: @list_item.todo_list_id } }
